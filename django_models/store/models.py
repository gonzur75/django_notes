...
class Product(models.Model):
    ...
    stock_count = models.IntegerField(help_text="How many items in stock")  # <input type='number'>
    price = models.DecimalField(max_digits=6, decimal_places=2)  # do kasy
    ...
    class Meta:
        ordering = ('price',)  # kosztowne obliczeniowo (zasadne tylko jeśli zawsze sortujemy po cenie)
